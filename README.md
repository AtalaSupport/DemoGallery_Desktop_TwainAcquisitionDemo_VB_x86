...
This is the VB.NET version. We also have a [C# Version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_TwainAcquisitionDemo_CS_x86) available.
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_TwainAcquisitionDemo_VB_x86.git TwainAcquisitionDemo
```
