...
Namespace AcquisitionDemo
    ...
    Public Class Form1 : Inherits System.Windows.Forms.Form
        ...
        Shared Sub New()
            ' NOTE: switch this to true if directed to enable force twain 1x behaivor by support
            ' also useful as a troubleshooting step for "oddly behaving scanner" 
            ' it is "safe" to leave true as it just forces scanners to use the far more 
            ' reliable Twain 1.x protocol instead of the less well implemented Twain 2.x protocol
            '
            ' If you need to add this to your app, make sure to do it in SHARED SUB NEW
            ' and not try and do it inline in code elsewhere.. it needs to be done before ANY 
            ' DotTwain related components try to initialize
